...
public class TransactionResponse implements Serializable
{
  ...
  /***********************************************************************/
  public TransactionResponse(String refId, String authCode, int result, String message, boolean zipVerified,
      boolean addressVerified)
  {
    ...
    this.originalResponse = "PNREF=" + refId + "&AUTHCODE=" + authCode + "&RESULT=" + result + "&RESPMSG="
        + message + "&AVSADDR=" + (addressVerified ? "Y" : "N") + "&AVSZIP=" + (zipVerified ? "Y" : "N");
  }
  /***********************************************************************/
