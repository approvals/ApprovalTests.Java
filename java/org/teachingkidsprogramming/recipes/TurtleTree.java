...
public class TurtleTree
{
  ...
  public static void main(String[] args)
  {
    ...
    //                  drawLowerBranches (recipe below)
    //                  ------------- Recipe for drawLowerBranches
    //                          Turn the Tortoise 30 degrees to the right
    //                          drawShorterBranch (recipe below)
    //                          ------------- Recipe for drawShorterBranch
    //                                  Decrease the length of the current branch by 10 pixels
    //                                  drawBranch 
    //                                  Increase the length of the current branch by 10 pixels
    //                          ------------- End of drawShorterBranch recipe
