...
```
<sup><a href='/approvaltests-util-tests/src/test/java/com/spun/util/StringUtilsTest.java#L53-L56' title='File snippet `join_collection` was extracted from'>snippet source</a> | <a href='#snippet-join_collection' title='Navigate to start of snippet `join_collection`'>anchor</a></sup>
<!-- endsnippet -->
will produce
...
```
<sup><a href='/approvaltests-util-tests/src/test/java/com/spun/util/StringUtilsTest.java#L62-L65' title='File snippet `join_collection_with_lambda` was extracted from'>snippet source</a> | <a href='#snippet-join_collection_with_lambda' title='Navigate to start of snippet `join_collection_with_lambda`'>anchor</a></sup>
<!-- endsnippet -->
will Produce
