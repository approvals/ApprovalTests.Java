...
public class AsErrorsTest
{
  ...
  void testFunction1()
  {
    ...
    Approvals.verifyException(
        () -> Functions.unchecked((m, p2, p3, p4, p5) -> returnException(m)).call("a", 2, 3, 4, 5));
    Approvals.verifyException(
        () -> Functions.unchecked((m, p2, p3, p4, p5, p6) -> returnException(m)).call("a", 2, 3, 4, 5, 6));
    Approvals.verifyException(
        () -> Functions.unchecked((m, p2, p3, p4, p5, p6, p7) -> returnException(m)).call("a", 2, 3, 4, 5, 6, 7));
    Approvals.verifyException(() -> Functions.unchecked((m, p2, p3, p4, p5, p6, p7, p8) -> returnException(m))
        .call("a", 2, 3, 4, 5, 6, 7, 8));
    Approvals.verifyException(() -> Functions.unchecked((m, p2, p3, p4, p5, p6, p7, p8, p9) -> returnException(m))
    ...
    Approvals
        .verifyException(() -> Actions.unchecked((m, p2, p3, p4, p5) -> returnException(m)).call("a", 2, 3, 4, 5));
    Approvals.verifyException(
        () -> Actions.unchecked((m, p2, p3, p4, p5, p6) -> returnException(m)).call("a", 2, 3, 4, 5, 6));
    Approvals.verifyException(
        () -> Actions.unchecked((m, p2, p3, p4, p5, p6, p7) -> returnException(m)).call("a", 2, 3, 4, 5, 6, 7));
    Approvals.verifyException(() -> Actions.unchecked((m, p2, p3, p4, p5, p6, p7, p8) -> returnException(m))
        .call("a", 2, 3, 4, 5, 6, 7, 8));
