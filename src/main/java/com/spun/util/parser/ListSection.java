...
public class ListSection
{
	...
	public static void main(String args[])
	{
		...
		int offset = 1;
		int max = 20;
		MySystem.variable("isListPoint() = " + l.isListPoint());
		MySystem.variable("getSectionStartingPoint() = " + l.getSectionStartingPoint(offset));
		MySystem.variable("getSectionEndPoint() = " + l.getSectionEndPoint(offset));
		MySystem.variable("isBeforeSection() = " + l.isBeforeSection());
		MySystem.variable("isAfterSection() = " + l.isAfterSection());
		MySystem.variable("getSize() = " + l.getSize());
		MySystem.variable("getBeforeSectionSize() = " + l.getBeforeSectionSize(max));
		MySystem.variable("getBeforeSectionStartIndex() = " + l.getBeforeSectionStartIndex(max,offset));
		MySystem.variable("getBeforeSectionEndIndex() = " + l.getBeforeSectionEndIndex(offset));
		MySystem.variable("getAfterSectionSize() = " + l.getAfterSectionSize(max));
		MySystem.variable("getAfterSectionStartIndex() = " + l.getAfterSectionStartIndex(offset));
		MySystem.variable("getAfterSectionEndIndex() = " + l.getAfterSectionEndIndex(max,offset));
	}
  /**
