...
public class UpdateVersion
{
  public static void main(String[] args) throws IOException
  {
    ...
    replaceTextInFile("README.md", "<version>\\d+.\\d+.\\d+</version>", "<version>" + version + "</version>");
    replaceTextInFile("README.md", "com.approvaltests:approvaltests:\\d+.\\d+.\\d+",
        "com.approvaltests:approvaltests:" + version);
  }
  private static void replaceTextInFile(String fileName, String regex, String replacement) throws IOException
  {
