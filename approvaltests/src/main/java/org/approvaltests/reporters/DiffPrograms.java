...
public class DiffPrograms
{
  ...
  public static class Mac
  {
    ...
    public static DiffInfo FILE_MERGE = new DiffInfo(
        "/Applications/Xcode.app/Contents/Applications/FileMerge.app/Contents/MacOS/FileMerge", "--nosplash -left %s -right %s", TEXT);
    ...
    public static DiffInfo KALEIDOSCOPE3 = new DiffInfo(
        "/usr/local/bin/ksdiff", TEXT_AND_IMAGE);
    public static DiffInfo KDIFF3 = new DiffInfo(
        "/Applications/kdiff3.app/Contents/MacOS/kdiff3", "%s %s -m", TEXT);
    public static DiffInfo P4MERGE = new DiffInfo(
        "/Applications/p4merge.app/Contents/MacOS/p4merge", TEXT_AND_IMAGE);
    public static DiffInfo TK_DIFF = new DiffInfo(
        "/Applications/TkDiff.app/Contents/MacOS/tkdiff", TEXT);
    ...
    public static DiffInfo DIFF_COMMAND_LINE = new DiffInfo(
        "/usr/bin/diff", "-u %s %s", TEXT);
  ...
  {
    public static DiffInfo BEYOND_COMPARE_3 = new DiffInfo(
        "{ProgramFiles}Beyond Compare 3\\BCompare.exe", TEXT_AND_IMAGE);
    public static DiffInfo BEYOND_COMPARE_4 = new DiffInfo(
        "{ProgramFiles}Beyond Compare 4\\BCompare.exe", TEXT_AND_IMAGE);
    public static DiffInfo BEYOND_COMPARE_5 = new DiffInfo(
        "{ProgramFiles}Beyond Compare 5\\BCompare.exe", TEXT_AND_IMAGE);
    ...
    public static DiffInfo WIN_MERGE_REPORTER = new DiffInfo(
        "{ProgramFiles}WinMerge\\WinMergeU.exe", TEXT_AND_IMAGE);
    public static DiffInfo ARAXIS_MERGE = new DiffInfo(
    ...
    public static DiffInfo KDIFF3 = new DiffInfo(
        "{ProgramFiles}KDiff3\\kdiff3.exe", TEXT);
    public static DiffInfo VISUAL_STUDIO_CODE = new DiffInfo(
        "{ProgramFiles}Microsoft VS Code\\Code.exe", "-d %s %s", TEXT);
    public static DiffInfo SUBLIME_MERGE = new DiffInfo(
        "{ProgramFiles}Sublime Merge\\smerge.exe", "mergetool %s %s", TEXT);
  }
  public static class Linux
  {
    public static DiffInfo DIFF_MERGE = new DiffInfo(
        "/usr/bin/diffmerge", "--nosplash %s %s", TEXT);
    public static DiffInfo MELD_MERGE = new DiffInfo(
        "/usr/bin/meld", "%s %s", TEXT);
    public static DiffInfo KDIFF3 = new DiffInfo(
        "/usr/bin/kdiff3", "%s %s -m", TEXT);
    public static DiffInfo DIFF_COMMAND_LINE = new DiffInfo(
        "/usr/bin/diff", "-u %s %s", TEXT);
    public static DiffInfo SUBLIME_MERGE = new DiffInfo(
        "/usr/bin/smerge", "mergetool %s %s", TEXT);
  }
}
