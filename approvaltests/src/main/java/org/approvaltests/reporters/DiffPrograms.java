...
public class DiffPrograms
{
  ...
  public static class Windows
  {
    ...
    public static DiffInfo BEYOND_COMPARE_4        = new DiffInfo("{ProgramFiles}Beyond Compare 4\\BCompare.exe",
        TEXT_AND_IMAGE);
    public static DiffInfo BEYOND_COMPARE_5        = new DiffInfo("{ProgramFiles}Beyond Compare 5\\BCompare.exe",
        TEXT_AND_IMAGE);
    ...
    public static DiffInfo VISUAL_STUDIO_CODE      = new DiffInfo("{ProgramFiles}Microsoft VS Code\\Code.exe",
        "-d %s %s", TEXT);
    public static DiffInfo SUBLIME_MERGE           = new DiffInfo("{ProgramFiles}Sublime Merge\\smerge.exe",
        "mergetool %s %s", TEXT);
  }
