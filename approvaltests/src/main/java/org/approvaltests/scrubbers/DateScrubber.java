...
public class DateScrubber extends RegExScrubber
{
  ...
  public static SupportedFormat[] getSupportedFormats()
  {
    return new SupportedFormat[]{__("[a-zA-Z]{3} [a-zA-Z]{3} \\d{2} \\d{2}:\\d{2}:\\d{2}", "Tue May 13 16:30:00"),
                                 ...
                                 __("\\d{4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{2}:\\d{2}(\\.\\d{1,9})?[+-]\\d{2}:\\d{2}",
                                     "2025-05-09T07:17:56.115+02:00", "2025-05-09T07:17:56.115-02:00",
                                     "2025-05-09T07:17:56+02:00"),
                                 __("\\d{4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{2}:\\d{2}(\\.\\d{1,9})?",
                                     "2025-10-22T13:34:31.8031254", "2025-10-22T13:34:31"),
